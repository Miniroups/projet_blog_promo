...
<form id="creationArticle" class="container content" method="post">
  ...
  <div class="row">
    ...
    <div class="col formInput form-group">
      ...
      <input type="text" placeholder="L'alternative de votre image ..." name="altImgArticle" value="<?php $alt_img = isset($alt_img) ? $alt_img : '' ?>">
    </div>
  </div>
  <div class="formInput form-group">
    <label for="texteArticle">Texte de votre article</label>
    <textarea placeholder="Entrez le texte de votre article ici ..." rows="10" name="texteArticle" value="<?php $content = isset($content) ? $content : '' ?>"></textarea>
  </div>
