<body>
    ...
    <div id="creationArticle" class="container">
        <div class="formInput form-group">
            ...
            <input type="text" placeholder="Le titre de votre article ..." name="titreArticle">
        </div>
        <div class="row">
            <div class="col formInput form-group">
                <label for="imageArticle">Image de l'article</label>
                <input type="text" placeholder="L'image de votre article ..." name="imageArticle">
            </div>
            <div class="col formInput form-group">
                <label for="altImgArticle">Alternative de l'image</label>
                <input type="text" placeholder="L'alternative de votre image ..." name="altImgArticle">
            </div>
        </div>
        <div class="formInput form-group">
